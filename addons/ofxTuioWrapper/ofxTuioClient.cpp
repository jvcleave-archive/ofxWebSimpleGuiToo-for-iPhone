...
void ofxTuioClient::addTuioObject(TuioObject *tobj) {
	...
	if (bVerbose)
		std::cout << "ofxTuioClient::addTuioObject " << tobj->getSymbolID() << " (" << tobj->getSessionID() << ") "<< tobj->getX() << " " << tobj->getY() << " " << tobj->getAngle() << std::endl;
...
void ofxTuioClient::updateTuioObject(TuioObject *tobj) {
	...
	if (bVerbose) 	
		std::cout << "ofxTuioClient::updateTuioObject " << tobj->getSymbolID() << " (" << tobj->getSessionID() << ") "<< tobj->getX() << " " << tobj->getY() << " " << tobj->getAngle() 
...
void ofxTuioClient::removeTuioObject(TuioObject *tobj) {
	...
	if (bVerbose)
		std::cout << "ofxTuioClient::removeTuioObject " << tobj->getSymbolID() << " (" << tobj->getSessionID() << ")" << std::endl;
}
...
void ofxTuioClient::addTuioCursor(TuioCursor *tcur) {
	...
	if (bVerbose) 
		std::cout << "ofxTuioClient::addTuioCursor " << " getCursorID: " << tcur->getCursorID() << " getSessionID: " <<  tcur->getSessionID() << " getX: " << tcur->getX() << " getY: " << tcur->getY() << std::endl;
...
void ofxTuioClient::updateTuioCursor(TuioCursor *tcur) {
	...
	if (bVerbose) 	
		std::cout << "ofxTuioClient::updateTuioCursor  " << " getCursorID: " << tcur->getCursorID() << " getSessionID: " <<  tcur->getSessionID() << " getX: " << tcur->getX() << " getY: " << tcur->getY() 
		<< " getMotionSpeed: " << tcur->getMotionSpeed() << " getMotionAccel: " << tcur->getMotionAccel() << " " << std::endl;
...
void ofxTuioClient::removeTuioCursor(TuioCursor *tcur) {
	...
	if (bVerbose)
		std::cout << "ofxTuioClient::removeTuioCursor " << " getCursorID: " << tcur->getCursorID() << " getSessionID: " <<  tcur->getSessionID() << std::endl;
