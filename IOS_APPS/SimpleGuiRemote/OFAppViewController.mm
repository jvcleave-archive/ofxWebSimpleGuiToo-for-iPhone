...
-(void) onTUIOButtonTap:(id)sender
{
	...
	tuioViewController.host = [data objectForKey:[ServerConfigValueObject SERVER_KEY]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath 
{
	...
	pageDetailViewController.host = [data objectForKey:[ServerConfigValueObject SERVER_KEY]];
